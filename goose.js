...
function game() {
    ...
    } while (deck.length !== 0 && cpu.length !== 0 || deck.length !== 0 && hand.length !== 0);
    determineWinner(); //calls the determine winner function after game is done
}
...
function cpuTurn () {
    ...
    do {
        ...
        if (checkRequest === true) {
            ...
            } while (check(hand, compRequest) === true);
...
function determineWinner() {
    //fill up this function with logic on how to determine the winner
}
